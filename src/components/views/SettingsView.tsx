        ...
        <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 mb-6">
                ...
                <div className="space-y-2 mb-4">
                    {people.map(person => (
                        <div key={person.id} className="flex items-center justify-between p-3 bg-zinc-800 rounded-lg border border-zinc-700">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                ...
                <div className="space-y-2 mb-4">
                    {categories.map(category => (
                        <div key={category.id} className="flex items-center justify-between p-3 bg-zinc-800 rounded-lg border border-zinc-700">
